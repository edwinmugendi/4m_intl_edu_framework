	...
	<form class="form-horizontal" action="{{ URL::to('groups') }}" method="post">   
        ...
        <div class="control-group" for="permissions">
            ...
            <div class="controls">
                ...
                <label class="checkbox inline">
                    <input type="checkbox" value="1" name="managerPermissions"> Manager
                </label>

                <label class="checkbox inline">
                    <input type="checkbox" value="1" name="supervisorPermissions"> Supervisor
                </label>

                <label class="checkbox inline">
                    <input type="checkbox" value="1" name="coachPermissions"> Coach
                </label>

                <label class="checkbox inline">
                    <input type="checkbox" value="1" name="translatorPermissions"> Translator
                </label>

                <label class="checkbox inline">
                    <input type="checkbox" value="1" name="emiratevpPermissions"> Emirate VP
                </label>
