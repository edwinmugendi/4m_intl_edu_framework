...
<div class="well">
	<table class="table">
		...
		@foreach ($allGroups as $group)
			<tr>
				<td>{{ $group->name }}</td>
				<td>{{ (isset($group['permissions']['admin'])) ? '<i class="icon-ok"></i> Admin' : ''}} 
					{{ (isset($group['permissions']['coach'])) ? '<i class="icon-ok"></i> Coach' : ''}} 
					{{ (isset($group['permissions']['translator'])) ? '<i class="icon-ok"></i> Translator' : ''}} 
					{{ (isset($group['permissions']['emiratevp'])) ? '<i class="icon-ok"></i> Emirate VP' : ''}} 
					{{ (isset($group['permissions']['users'])) ? '<i class="icon-ok"></i> Users' : ''}}</td>
