...
<h4>User Schools</h4>
<div class="well">
    <form class="form-horizontal" action="{{ URL::to('users/updateschools') }}/{{ $user->id }}" method="post">
        {{ Form::token() }}
            <table class="table">
                <thead>
                <th>School</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="switch" data-on-label="In" data-on='info' data-off-label="Out">
                            <input name="schools[{{ $school->id }}]" type="checkbox" {{ ( $userSchools->contains($school->id)) ? 'checked' : '' }} >
                        </div>
                    </td>
                </tr>
                @endforeach
            ...
            <div class="form-actions">
                <input class="btn-primary btn" type="submit" value="Update School Association">
            </div>
    </form>
</div>
